    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=67, verbose_name='Имя')),
                ('last_name', models.CharField(max_length=67, verbose_name='Фамилия')),
                ('email', models.EmailField(max_length=67, unique=True, verbose_name='email')),
                ('username', models.CharField(max_length=67, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='username')),
